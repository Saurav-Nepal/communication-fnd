...
const SavedFilterItem = ({
    ...
    }, [data?.id, data?.user_id, isDeletable, makeItSome, onApply, onEdit]);
    ...
    return (
        <div
            className={cn(
                'flex justify-between px-3 py-2 mb-1 border rounded border-base-300 bg-base-200 hover:bg-base-100 group',
                {
            ...
            <div className='flex items-center gap-3'>
                ...
                >
                    <Icon
                        ...
                        isSvg
                        className={cn(
                            'text-base-primary/10 group-hover:text-base-primary',
                            {
            ...
            <div className='flex'>
                {isDeletable && (
                    <Icon
                        ...
                        isSvg
                        className={cn(
                            'mr-2 cursor-pointer text-base-primary/10 group-hover:text-base-primary hover:!text-error ',
                            {
                                'text-base-primary': isActive,
                            }
                        )}
