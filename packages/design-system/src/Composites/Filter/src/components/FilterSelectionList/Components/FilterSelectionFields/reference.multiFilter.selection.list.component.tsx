...
import { ReferenceMultiSelectInterface } from '../../../../../../../Components';
import { MultiFilterSelectionList } from './multiFilter.selection.list.component';

export const ReferenceMultiFilterSelectionList = ({
    controller_type,
    method = 'find',
    valueKey = 'id',
    labelKey = 'name',
