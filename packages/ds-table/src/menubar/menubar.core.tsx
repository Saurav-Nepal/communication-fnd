...
>(({ className, ...props }, ref) => (
    <MenubarPrimitive.SubContent
        ref={ref}
        className={cn(
            'z-50 min-w-[8rem] overflow-hidden rounded border bg-popover p-1 text-popover-foreground shadow animate-in data-[side=bottom]:slide-in-from-top-1 data-[side=left]:slide-in-from-right-1 data-[side=right]:slide-in-from-left-1 data-[side=top]:slide-in-from-bottom-1',
            className
        )}
        {...props}
    />
    ...
    (
        ...
        <MenubarPrimitive.Portal>
            <MenubarPrimitive.Content
                ...
                className={cn(
                    'z-50 min-w-[12rem] overflow-hidden rounded-md border bg-popover popover p-1 text-popover-foreground shadow-md animate-in slide-in-from-top-1',
                    className
                )}
                {...props}
            />
