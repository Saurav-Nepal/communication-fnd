...
import { DATA_OPERATORS } from '../../constants/datatype.constants';
import { QueryOperatorList } from '../../constants/operator.constant';
...
export const FilterProvider = ({
    ...
    const hasVisibleFilterBtn = useMemo(() => {
        return (
            listFilters.filter(
                (filter: ObjectDto) => filter?.isOuterFilter !== true
            ).length > 0
        );
    }, [listFilters]);
