...
export interface TableProps {
    ...
    openSnModal?: (item: ObjectDto) => void;
}
...
export interface TablePreferencesProps {
    appearance?: keyof typeof TableAppearanceTypes; // Appearance type of the table
    size?: keyof typeof TableSizesTypes; // Size type of the table
    hasRoundedCorners?: boolean; // Whether to have rounded corners
    isBordered?: boolean; // Whether to have borders
    isFullHeight?: boolean; // Whether the table should take full height
    isStickyHeader?: boolean; // Whether the table header should be sticky
    isStickyRowAction?: boolean; // Whether the row actions should be sticky
}
